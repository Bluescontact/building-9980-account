...
supplemented the same day (RECORD timeline, Sep 3 rows; ledger entries 18–19). The
charges arc asks procedure of one seat and is not a gift; it is kept apart from
gifts/ by the record's own rule.

**Provenance, verified Sep 3, 2026:** this file is byte-identical (SHA-256
75ea2d7627a93e8f…) to the attachment extracted from the raw MIME of the sent
...
republished — it exists only as the carrier of the distribution list.
