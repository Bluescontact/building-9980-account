...
States: DELIVERED → RECEIVED → RESPONDED → REFERRED → DISPOSED.
Response is not disposition: a jurisdiction answer becomes a disposition only when it names
the seat whose it is.
...
| Venue | When | Came back | Case number | For the worker |
|---|---|---|---|---|
