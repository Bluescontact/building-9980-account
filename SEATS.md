...
| NTESS ECP | Ethicsteam@sandia.gov | same list | notice + PDF (22:01Z) and omnibus |
...
only with document-anchored questions. Every person above is already named in a federal
record by the giver (OIG narrative, Sep 3, 2025, identity disclosure consented) — public
naming repeats a federal filing; it does not create a first disclosure.
