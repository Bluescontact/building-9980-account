# Reference — what carries weight, verified

*Only documents verified against the live source or held in hand. Each entry states what
the document actually says, at the level it says it. A public document is entered for what
it says — never for what one hopes it says.*
...
- **DOE O 221.1B** — *Reporting Fraud, Waste and Abuse to the OIG*. Narrow uses: no one may
  restrict an employee's communication with the OIG; ¶5.a(7)(b) places a referral duty on
...
## 3. The Agreement (NEBA 2022–2027, in hand)
...
- **Art. XXVII Par. 4** — employer must advise, train, and equip for hazardous materials
  (the clause behind the Jan 16 request).
- **Art. XXII Par. 5(e)** — safety infractions carved out of the 24-month warning sunset.
- **Background-Check Letter of Agreement** — federal-site conditions on a volunteer /
  alternative-work-or-layoff basis; the only federal-site clause found in the Agreement.
- **Art. XV** — grievance timelines (the clock rule's anchor).

## 4. Case law — what survives
...
and the "I don't feel safe" meeting).
